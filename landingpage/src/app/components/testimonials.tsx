...
const Testimonials = () => {
  return (
    <div className="customers-container w-full py-16 bg-white flex flex-col items-center">
      ...
      <div className="customers-grid w-[90%] max-w-[1200px] flex flex-col gap-8">
        <div className="flex flex-col md:flex-row justify-center gap-8">
          {/* Testimonial 1 */}
          <div className="flex flex-col items-start w-full md:w-[45%] min-w-[240px] h-[auto]">
        ...
        {/* Testimonial 3 */}
        <div className="flex flex-col items-start w-full md:w-[45%] min-w-[240px] mx-auto h-[auto]">
          <div className="customer-card bg-blue-50 p-6 rounded-lg flex flex-col justify-center h-full w-full">
            <p className="customer-quote text-base leading-relaxed text-gray-700 text-sm">
